    ...
    <section class="features-area" id="features-area">
      <div class="container">
        <div class="section-heading row">
          ...
          <p>
            International Journal of Scientific Research in Engineering & Technology is (e-ISSN: 2583-1240)
            Bi-monthly, international peer-reviewed, open-access and multidisciplinary online journal published for the
            enhancement of research in various disciplines of Science, Engineering &Technologies.
          </p>
          <p>
            ...
            Science, Engineering & Technology, various engineering disciplines, etc. IJSREAT is a scholarly, open,
            accessible, Peer Review Journal that helps an academic person and student community. IJSREAT provides the
          ...
          <p>
            ...
            the journals approved by UGC-CARE, or journals indexed in Scopus or Web of Science. IJSREAT is a peer
            reviewed journal (refereed journals) and therefore fitting within UGC's recommendations.

          </p>
          <p>Publishing an article in a Peer-Reviewed Journal is critical for developing a cohesive and acknowledged
          ...
          <div class="row">
            <div class="col">
              <ul>
                <li>
                  <p>
                    <b>Title :</b>International Journal Of Scientific Research
            ...
            <div class="feature-box">
              ...
              <div class="feature">
                <div class="f-icon">
                  <svg enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512"
                    ...
                    <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="256" x2="256" y1="512" y2="0">
                      <stop offset="0" stop-color="#D1A614" />
                      <stop offset="1" stop-color="#D1A614" />
                    </linearGradient>
                    <g>
                      <g>
                        <path
                ...
                <div class="f-description">
                  ...
                  <ul>
                    <li>
                      <p>High Visibility & Indexing
                       </p>
                    </li>
                    <li>
                      <p>Strict Plagiarism policy
                      </p>
                    </li>
                    <li>
                      <p>Open Access Journal
                      </p>
                    </li>
                  </ul>
                </div>
            ...
            <div class="feature-box">
              ...
              <div class="feature">
                ...
                <div class="f-description">
                  ...
                  <ul>
                    <li>
                      <p>Status Notification: with in 24Hrs</p>
                    </li>
                    <li>
                      <p>Every Process: Email & SMS
                      </p>
                    </li>
                    <li>
