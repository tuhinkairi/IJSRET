    ...
    <section class="review-area">
      <div class="container">
        <div class="section-heading text-center mx-auto mb-28">
          <h1 class="review">Client Reviews</h1>
          <p>
        ...
        <div class="rating text-center mx-auto mb-72">
          <p>
            Average rating
            <span>4.9 / 5 <font-awesome-icon :icon="['fas', 'star']" /></span>
          </p>
        </div>
        <VueSlickCarousel v-bind="settings" class="row review-slider">
            <template #prevArrow>
          ...
          <div>
            <div class="review">
              <div class="review-text">
                <img alt="image" src="@/assets/Images/reviewTop.png" width="31" height="27"/>
                <!-- <svg
                ...
                <img alt="image" src="@/assets/Images/reviewBottom.png" width="31" height="27" class="float-right"/>
                <!-- <svg
                  class="float-right"
                  xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <div class="client-profile">
                ...
                <div class="client-details">
                  ...
                  <span class="client-rating"
                    >5 / 5 <font-awesome-icon :icon="['fas', 'star']"
                  /></span>
                </div>
              </div>
            </div>
            ...
            <div class="review">
              ...
              <div class="client-profile">
                ...
                <div class="client-details">
                  ...
                  <p>HD Manager</p>
                  <span class="client-rating"
                    >4.8 / 5 <font-awesome-icon :icon="['fas', 'star']"
                  /></span>
                </div>
              </div>
            </div>
